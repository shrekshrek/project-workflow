...
v2.9.38 ships **11 skills + 6 sub-agents** covering the full P0→P2→P3→P4 lifecycle. The remaining skills are still gathering field hours — battle-testing welcome.
