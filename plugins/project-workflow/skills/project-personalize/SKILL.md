...
- 想加 framework rules:从 `$PLUGIN_ROOT/template/.claude/rules/_examples/<framework>.example.md` 复制,改 globs + description;`$PLUGIN_ROOT` 指当前安装的 project-workflow plugin 根目录(Claude/Codex adapter 各自解析)
