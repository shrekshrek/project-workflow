...
- **互补**:`/spec-revise` = in-feature reactive;`/feature-done` proof bundle Item 5b = per-feature backlog(append 进 `.claude/drift-ledger.md`);本 skill = project-wide phase audit(读取端聚类 ledger,见 Step 3)
