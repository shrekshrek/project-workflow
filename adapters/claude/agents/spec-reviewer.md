---
name: spec-reviewer
description: Claude Code adapter for L3 implementation-vs-feature compliance. Reads docs/reviewers/spec-reviewer.md; checks the accepted full or light artifact. Domain docs are context only.
...
2. the target feature's `spec.md`, or `tasks.md` for light lane
