...
- Use Codex-native questions/approval for canonical decision groups and their lifecycle/current-truth changes;
  present evidence and a recommendation without choosing a winner silently.
