...
- Use an inline value-to-source trace for simple synchronization. At the canonical boundary, run [`../../../../docs/reviewers/decision-completeness-auditor.md`](../../../../docs/reviewers/decision-completeness-auditor.md) in a general subagent when available; main-session fallback follows the same contract.
