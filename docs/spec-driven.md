...
| L3 spec 合规局部复查 | [`/l3-review`](../skills/l3-review/SKILL.md) —— Claude helper surface;dispatch [`spec-reviewer`](../agents/spec-reviewer.md) agent,按 §1 Outcomes / §2 Scope / §3 Constraints / §4 Verification 分组报告 |
