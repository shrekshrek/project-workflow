...
- If the revision changes durable behavior recorded in `docs/specs/<area>.md`, update that document (or record why not); if it supersedes earlier specs, apply the lifecycle markers per [`spec-reconcile`](spec-reconcile.md) or record the follow-up.
