...
- An explicit single-feature invocation or enclosing close/archive/submit request needs no duplicate approval. Use Claude's native question flow for sweep candidates and uncertain area, supersession, or ADR decisions.
